...
// Login Method
export const postApiLogin = data => api.create(url.POST_API_LOGIN, data);

// Register Method
export const postFakeRegister = data => api.create(url.ADD_ASPIRANTES, data);

// Register Method
export const getAspirantesList = (params) => api.get(url.GET_ASPIRANTES, params);
export const postAddAspirante = (params, data) => api.createParms(url.ADD_ASPIRANTES, params, data);
export const getAspirante = (params) => api.get(url.GET_ASPIRANTES_BY_ID, params);
export const updatespirante = (params, data) => api.put(url.UPD_ASPIRANTES, params, data);
export const deleteAspirante = (params) => api.delete(url.DEL_ASPIRANTES, params);

// Aspirantes
export const setAspirantesEvaluar = data => api.create(url.ASPIRANTES_EVALUAR, data);
export const setAspirantesLlamar = data => api.create(url.ASPIRANTES_LLAMAR, data);
export const setAspirantesAprobar = data => api.create(url.ASPIRANTES_APROBAR, data);
export const setAspirantesRechazar = data => api.create(url.ASPIRANTES_RECHAZAR, data);
export const setAspirantesContratar = data => api.create(url.ASPIRANTES_CONTRATAR, data);

// Requisicion
export const getRequisicionesList = params => api.get(url.GET_REQUISICIONES, params);
export const postAddRequisicion = (params, data) => api.createParms(url.ADD_REQUISICION, params, data);
export const getRequisicionbyID = params => api.get(url.GET_REQUISICION_BY_ID, params);
export const getRequisicionesCatalogos = params => api.get(url.GET_CAT_REQUISICIONES, params);
export const updateRequisicion = (params, data) => api.put(url.UPD_REQUISICION, params, data);
export const deleteRequisicion = (params, data) => api.deleteParamsData(url.DEL_REQUISICION, params, data);
export const updateEstatusRequisicion = (params, data) => api.put(url.UPE_REQUISICION, params, data);

// Flujo de Contratacion
export const getFlujoContratacionList = params => api.get(url.GET_FLUJOS_CONTRATACION, params);
export const postAddFlujoContratacion = (params, data) => api.createParms(url.ADD_FLUJO_CONTRATACION, params, data);
export const getFlujoContratacionbyID = params => api.get(url.GET_FLUJO_CONTRATACION_BY_ID, params);
export const getFlujoContratacionCatalogos = params => api.get(url.GET_CAT_FLUJO_CONTRATACION, params);
export const updateFlujoContratacion = (params, data) => api.put(url.UPD_FLUJO_CONTRATACION, params, data);
export const deleteFlujoContratacion = (params, data) => api.deleteParamsData(url.DEL_FLUJO_CONTRATACION, params, data);

// ChatBot
// get Contact
export const getDirectContact = () => api.get(url.GET_DIRECT_CONTACT);
// get Messages
export const getMessages = roomId => api.get(`${url.GET_MESSAGES}`, { params: roomId });
// add Message
export const addMessage = (params, message) => api.createParms(url.ADD_MESSAGE, params, message);
// add Message
...
// Usuarios
export const postAddUsuario = (params, message) => api.createParms(url.ADD_USUARIO, params, message);
export const getUsuariosList = data => api.get(url.GET_USUARIOS, data);
export const getUsuariosbyID = params => api.get(url.GET_USUARIO_BY_ID, params);
