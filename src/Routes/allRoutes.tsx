...
import AspiranteRecepcion from "../pages/RRHH/CandidateList/ListView/Modals/AspiranteRecepcion";


//Chat
import ChatBot from "../pages/RRHH/ChatBot";
...
import CandidateList from "../pages/RRHH/CandidateList/ListView";
import CandidateOverview from "../pages/RRHH/CandidateList/Overview";
import BoardList from "../pages/RRHH/CandidateList/ListView/BoardList";
import RecepcionCandidatosList from "../pages/RRHH/RecepcionCandidatosList/ListView";
import RequisicionCandidatosList from "../pages/RRHH/RequisicionCandidatosList/ListView";
import RequisicionCandidatosNew from "../pages/RRHH/RequisicionCandidatosList/NewRequisicion";
import RequisicionCandidatosEdit from "../pages/RRHH/RequisicionCandidatosList/EditRequisicion";

// Flujo de Contratacion
import FlujoContratacionList from "../pages/RRHH/FlujoContratacion/ListView";
import FlujoContratacionNew from "../pages/RRHH/FlujoContratacion/NewFlujoContratacion";
import FlujoContratacionEdit from "../pages/RRHH/FlujoContratacion/EditFlujoContratacion";

// Systema
import SysUsersListList from "../pages/Systema/Usuarios/ListView";
import SysCatalogosList from "../pages/Systema/Catalogos/ListView";

/*import CandidateGrid from "../pages/RRHH/CandidateList/GridView";
...
const authProtectedRoutes = [
  { path: "/job-candidate-lists", component: <CandidateList /> },
  { path: "/job-candidate-lists/overview-candidate", component: <CandidateOverview /> },
  { path: "/job-reception-lists", component: <RecepcionCandidatosList /> },
  { path: "/job-requisicion-lists", component: <RequisicionCandidatosList /> },
  { path: "/job-requisicion-lists/edit", component: <RequisicionCandidatosEdit /> },
  { path: "/job-requisicion-new", component: <RequisicionCandidatosNew /> },
  { path: "/job-board", component: <BoardList /> },

  // Flujo de Contratacion
  { path: "/job-flow-lists", component: <FlujoContratacionList /> },
  { path: "/job-flow-new", component: <FlujoContratacionNew /> },
  { path: "/job-flow-lists/edit", component: <FlujoContratacionEdit /> },

  // Sistema
  { path: "/sys-users-lists", component: <SysUsersListList /> },
  { path: "/sys-catalogos-lists", component: <SysCatalogosList /> },
...
const publicRoutes = [
  ...
  { path: "/AspiranteRecepcion", component: <AspiranteRecepcion /> },
