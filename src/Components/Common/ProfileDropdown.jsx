...
const ProfileDropdown = () => {
    ...
    useEffect(() => {
        ...
        if (sessionStorage.getItem("authUser")) {
            setUserName(import.meta.env.VITE_APP_DEFAULTAUTH === "fake" ? obj.username === undefined ? obj.data.first_name ? obj.data.first_name : user.first_name : "Admin" || "Admin" :
                import.meta.env.VITE_APP_DEFAULTAUTH === "firebase" ? obj.email && obj.email : "Admin"
            );
        }
    }, [userName, user]);
