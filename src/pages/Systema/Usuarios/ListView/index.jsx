...
const SysUsersListList = () => {
  ...
  const selectDashboardData = createSelector(
      ...
      (Usuarios) => Usuarios.usuariosLists
  );

  // Inside your component
  const usuariosLists = useSelector(selectDashboardData);

  //pagination
  const setCurrentPage = (currentPage) => {
      dispatch(onGetUsuariosList({Page: currentPage}));
  }

  const setRowsByPage = () => {
    if(usuariosLists)
      dispatch(onGetUsuariosList({ RowsByPage: 100 }));
  }
  ...
  useEffect(() => {
      //set Project(usuariosLists);
      /*if(usuariosLists.pagination){
          //setPagination(usuariosLists.pagination.actualPage);
      }*/
  }, [usuariosLists]);
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        ...
        <Container fluid>
          <BreadCrumb title="Usuarios" pageTitle="Sistema" />
          <Row>
            <Col>
              <Card>
...
export default SysUsersListList;
