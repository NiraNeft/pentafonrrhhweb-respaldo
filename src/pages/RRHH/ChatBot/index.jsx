...
const chatContactData = [
  ...
  const [Chat_Box_Username, setChat_Box_Username] = useState("ChatBotAI");
  const [Chat_Box_UserId, setChat_Box_UserID] = useState(2);
  ...
  const [verMensajeEnviado, setVerMensajeEnviado] = useState(false);


  const selectLayoutState = (state) => state.ChatBot;
      ...
      <div className="page-content">
        <Container fluid>
          <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
            <div className="chat-leftsidebar d-none" >
                  ...
                  >
                    ...
                    <div className="chat-message-list">
                      <ul
                        ...
                        id="channelList"
                      >
                        {(channels.items || []).map((channel, key) => (
                        ...
                        <PerfectScrollbar
                          ...
                          >
                            {messages && messages.items &&
                              map(messages.items, (message, key) => (
                                <li
                                  className={
                                    message.from_id === Chat_Box_UserId
                                      ? " chat-list left"
                                      : "chat-list right"
                                  }
                                  key={key}
                              ...
                              {verMensajeEnviado ?
                                ...
                                >
                                  <div className="conversation-list">
                                    {verMensajeEnviado.from_id === Chat_Box_UserId && (
                                      <div className="chat-avatar">
                                        {Chat_Box_Image === undefined ?
                                          <img
                                            src={userDummayImage}
                                    ...
                                    <div className="user-chat-content">
                                      <div className="ctext-wrap">
                                        <div className="ctext-wrap-content">
                                          <p className="mb-0 ctext-content">
                                            {verMensajeEnviado.msg}
                                          </p>
                                        </div>
                                      </div>
                                      <div className="conversation-name">
                                        <small className="text-muted time">
                                        {verMensajeEnviado.datetime}
                                        </small>{" "}
                                        <span className="text-success check-message-icon">
                                          <i className="ri-check-double-line align-bottom"></i>
                                        </span>
