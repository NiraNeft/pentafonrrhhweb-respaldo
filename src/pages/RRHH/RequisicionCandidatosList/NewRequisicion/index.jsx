...
import {
    postAddRequisicion, resetAddRequisicionFlag,
...
const NewJobs = () => {
  ...
  document.title = "Nueva Requisición | Pentafon";
      ...
      formConfig: {
        ...
        useFormik: {
            values: {
              ...
              "DatosCliente-Email_Contacto": frontFormikEmail({ label: "Email de contacto", required: "Por favor, selecciona una opcion", defaultValue: 'algo@gmail.com', ColMd: 4, YupMax: 200 }),
              ...
              "OfertaLaboral-Descripcion_Puesto": frontFormikCked("Descripción del puesto", "Por favor, llene el campo", "descripcion requisiciones"),
              /*Fecha de cierre de Requisición*/
              "OfertaLaboral-Fecha_Cierre": frontFormikDate({ label: "Fecha de cierre de Requisición", required: "Por favor, llene el campo", ColMd: 4 }),
              /*Vacantes solicitadas*/
              "OfertaLaboral-Vacantes_Solicitadas": frontFormikNumber({ label: "Vacantes solicitadas", required: "Por favor, llene el campo", ColMd: 4, defaultValue: "10" }),
              /*Salario | Base + Variable*/
              "OfertaLaboral-Salario_Base": frontFormikMoney({ label: "Salario", required: "Por favor, llene el campo",ColMd: 4, defaultValue: "10" }),
              "OfertaLaboral-Salario_Variable": frontFormikMoney({ label: "Base + Variable", required: "Por favor, llene el campo",ColMd: 4, defaultValue: "10" }),
              /*Lugar de trabajo*/
        ...
        titles: {
            modalHeader: { color: "info", title: "Datos de la Requisición" },
            btnSubmit: "Agregar"
        },
        function: {
