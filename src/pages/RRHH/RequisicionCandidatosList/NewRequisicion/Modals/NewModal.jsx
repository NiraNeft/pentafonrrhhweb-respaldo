              ...
              formConfig: {
                ...
                useFormik: {
                    values: {
                      ...
                      "DatosCliente-Email_Contacto": frontFormikEmail({ label: "Email de contacto", required: "Por favor, selecciona una opcion", defaultValue: 'algo@gmail.com', ColMd: 12, YupMax: 200 }),
                ...
                titles: {
                    modalHeader: { color: "info", title: "Datos del Nuevo Cliente" },
                    btnSubmit: "Solicitar"
                },
                function: {
