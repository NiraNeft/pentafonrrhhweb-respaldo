...
import {
    Card, CardBody, CardHeader, Col, DropdownItem, DropdownMenu, 
    DropdownToggle, Row, UncontrolledDropdown, Table,
    Button
} from 'reactstrap';
...
const OverviewTab = ({aspiranteData}) => {
    return (
        <React.Fragment>
            <Row>
                <Col xl={9} lg={8}>
                    <Card>
                        <CardBody>
                            <div className="text-muted">
                                <h6 className="mb-3 fw-semibold text-uppercase">Resumen</h6>
                                <div>{aspiranteData.DescripcionCampania}</div>
                                ...
                                <div className="pt-3 border-top border-top-dashed mt-4">
                                    <Row>
                                        <Col lg={4} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Evaluacion 1:</p>
                                                <button type="button" className="btn btn-sm btn-success"><i className="ri-add-line align-middle me-1"></i> Asignar</button>
                                                <p></p>
                                            </div>
                                        </Col>
                                        <Col lg={4} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Evaluacion 2:</p>
                                                <button type="button" className="btn btn-sm btn-success"><i className="ri-add-line align-middle me-1"></i> Asignar</button>
                                                <p></p>
                                            </div>
                                        </Col>
                                        <Col lg={4} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Evaluacion 3:</p>
                                                <button type="button" className="btn btn-sm btn-success"><i className="ri-add-line align-middle me-1"></i> Asignar</button>
                                                <p></p>
                                            </div>
                                        </Col>
                                        <Col lg={4} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">LLamar candidato:</p>
                                                <button type="button" className="btn btn-sm btn-success"><i className="ri-add-line align-middle me-1"></i> Asignar</button>
                                                <p></p>
                                            </div>
                                        </Col>
                                        <Col lg={4} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Revisar :</p>
                                                <button type="button" className="btn btn-sm btn-success"><i className="ri-add-line align-middle me-1"></i> Asignar</button>
                                                <p></p>
                                            </div>
                                        </Col>
                                        <Col lg={4} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Documentos:</p>
                                                <button type="button" className="btn btn-sm btn-info"><i className="ri-eye-fill align-middle me-1"></i> Revisar</button>
                                                <p></p>
                                            </div>
                                        </Col>
                                        <Col lg={6} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Contrato:</p>
                                                <button type="button" className="btn btn-sm btn-success"><i className="ri-add-line align-middle me-1"></i> Agregar</button>
                                                <div className="border rounded border-dashed p-2">
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="flex-grow-1 overflow-hidden">
                                                            <h5 className="fs-13 mb-1"><Link to="#" className="text-body text-truncate d-block">Velzon admin.pdf</Link></h5>
                                                            <div>2.4MB</div>
                                                        </div>
                                        ...
                                        <Col lg={4} sm={6}>
                                            <div>
                                                <p className="mb-2 text-uppercase fw-medium">Grabacion:</p>
                                                <button type="button" className="btn btn-sm btn-success"><i className="ri-add-line align-middle me-1"></i> Agregar</button>
                                                <br />
                                            </div>
                                        </Col>
                ...
                <Col xl={3} lg={4}>
                    <Card>
                        <CardBody>
                            <h5 className="card-title mb-4">Información</h5>
                            <Row className="align-items-center g-3">
                                <div className="col-12">
                                    <h5 className="text-muted mt-0 mb-1 fs-13">Tipo Campania</h5>
                                    <Link to="#" className="text-reset fs-14 mb-0">{aspiranteData.TipoCampania}</Link>
                                </div>
                                <div className="col-12">
                                    <h5 className="text-muted mt-0 mb-1 fs-13">Producto/Servicio</h5>
                                    <Link to="#" className="text-reset fs-14 mb-0">{aspiranteData.ProductoServicio}</Link>
                                </div>
                            </Row>
