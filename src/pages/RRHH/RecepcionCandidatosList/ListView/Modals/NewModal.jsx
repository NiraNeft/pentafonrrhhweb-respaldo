...
// action
import { postAddAspirante, resetCreateFlag, resetFlags } from "../../../../../slices/thunks";
import NewModalCaptura from "./NewModalCaptura";
import {
    LabelInput,
    TextInput,
    TextBtnInput,
  ...
  const productCountry = [
    ...
    const validation = useFormik({
        ...
        initialValues: {
            ...
            Apellido_Paterno: userAspirante.Apellido_Paterno || "Apellido Paterno" || '',
